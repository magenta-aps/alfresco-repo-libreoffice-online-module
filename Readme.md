...
It does not implement the full WOPI protocol, merely the CheckFileInfo, GetFile and PutFile endpoint interface(s).

This module was developed against Alfresco version 5.0.d.       
        
### Webapplication Open Platform Interface protocols
See http://wopi.readthedocs.io/projects/wopirest/en/latest/endpoints.html

### Installing
First install LibreOfficeOnLine.<br/>
See LibreOffice Online Github page: https://github.com/LibreOffice/online for the latest installation instructions.<br/>
...
The page module evaluator requires JDK higher than or equal to version 8. Go to http://www.oracle.com/technetwork/java/javase/downloads/index.html and click on button "Download JDK".  There are installation instructions on that page as well. To verify that your installation was successful, run "java -version" on the command line.  That should print the installed version of your JDK.
