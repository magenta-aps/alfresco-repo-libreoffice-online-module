...
public class LibreOfficeOnlineGetTokenWebScript extends DeclarativeWebScript {
    ...
    protected Map<String, Object> executeImpl(
        ...
        String accessToken = loolService.getAccessToken(nodeRef);
        String wopiSrcUrl = null;
        try {
